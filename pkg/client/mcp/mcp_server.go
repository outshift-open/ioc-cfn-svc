...
// ServeHTTPWithShutdown starts the MCP server over HTTP and returns a shutdown function.
func ServeHTTPWithShutdown(server *mcp.Server, addr string) (*http.Server, func() error) {
	log := getLogger()
