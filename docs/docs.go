...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app.IngestMetricsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/internal/l9/audit": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by L9 kind (intent, exchange, contingency, commit, knowledge)",
                        "name": "kind",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "Paginated list of L9 audit events",
                        "schema": {
                            "$ref": "#/definitions/audit.L9AuditListResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid parameters",
        ...
        "/api/internal/l9/audit/{eventId}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "L9 audit event",
                        "schema": {
                            "$ref": "#/definitions/audit.L9AuditEvent"
                        }
                    },
                    "400": {
        ...
        "/api/internal/mgmt/workspaces/{workspaceId}/multi-agentic-systems/{masId}/metrics": {
            "get": {
                "description": "Returns time-series token usage and LLM operation metrics for a MAS across all attached CEs.\nOptionally filter by ce_id, agent_id, or metric_name.\nResponse groups datapoints by (metric_name, ce_id, agent_id, attributes) to distinguish contributions from different CEs.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by Cognition Engine UUID",
                        "name": "ce_id",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/app.MASMetricsQueryResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid parameters",
        ...
        "/api/workspaces/{workspaceId}/multi-agentic-systems/{masId}/agents/{agentId}/rag/similarity-search": {
            "post": {
        ...
        "/api/workspaces/{workspaceId}/multi-agentic-systems/{masId}/agents/{agentId}/rag/vectors": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sharedmemory.AgentVectorUpsertRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sharedmemory.AgentVectorDeleteRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "Vector store or record not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
    ...
    "definitions": {
        "app.CEMetricGroup": {
            ...
            "properties": {
                ...
                "series": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/app.MASMetricSeries"
                    }
                }
            }
        },
        ...
        "app.MASMetricsQueryResponse": {
            "type": "object",
            "properties": {
                "ces": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/app.CEMetricGroup"
                    }
                },
                "end_time": {
                    "type": "string"
        ...
        "audit.L9AuditEvent": {
            ...
            "properties": {
                "actors": {
                    "description": "Participants (stored as JSONB array of {id, role} objects)",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
                ...
                "context": {
                    "description": "Context (full header.context as JSONB)",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
                ...
                "message_id": {
                    "description": "Message identity",
                    "type": "string"
                },
                "parent_ids": {
                    "description": "Parents identity",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
        ...
        "audit.L9AuditListResponse": {
            ...
            "properties": {
                ...
                "pageInfo": {
                    "$ref": "#/definitions/audit.PageInfo"
                }
            }
        },
        "audit.PageInfo": {
        ...
        "sharedmemory.AgentVectorUpsertRecord": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
                ...
                "embedding": {
                    "$ref": "#/definitions/sharedmemory.VectorEmbeddingPayload"
                },
                "id": {
                    "type": "string"
                },
        ...
        "sharedmemory.AgentVectorUpsertRequest": {
            "type": "object",
            "properties": {
                "records": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/sharedmemory.AgentVectorUpsertRecord"
                    }
                },
                "request_id": {
                    "type": "string"
        ...
        "sharedmemory.VectorEmbeddingPayload": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
