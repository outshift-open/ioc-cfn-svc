...
Internet of Cognition (IOC) Cognition Fabric Node (CFN) Service project.
...
The Internet of Cognition (IOC) Cognition Fabric Node (CFN) Service maintainers take all security issues in the project
seriously. Thank you for improving the security of the Internet of Cognition (IOC) Cognition Fabric Node (CFN) Service. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

The Internet of Cognition (IOC) Cognition Fabric Node (CFN) Service leverages GitHub's private vulnerability reporting.
