...
The `ioc-cfn-svc` maintainers take all security issues in the project
seriously. Thank you for improving the security of `ioc-cfn-svc`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`ioc-cfn-svc` leverages GitHub's private vulnerability reporting.
